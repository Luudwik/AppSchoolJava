...
/**
 * The EditGradesWindow class represents a window for editing grades.
...
public class EditGradesWindow extends JFrame {
    ...
    /**
     * Launches the EditGradesWindow application.
    ...
    /**
     * Constructs an EditGradesWindow object.
     * @param choosedMarkTxt the selected mark text
     * @param choosedTypeTxt the selected type text
     * @param firstName the first name of the student
     * @param surname the surname of the student
     * @param choosedIDInt the selected ID
     */
